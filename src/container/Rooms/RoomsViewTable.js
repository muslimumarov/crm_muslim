  ...
  return (
    <div className='container mx-auto mt-[23px] relative min-h-screen'>
        <div className='flex items-center justify-between'>
            <h4 className='text-[26px] text-[#002B48] leading-[39px]'>Xonalar</h4>
            <Link href={"/rooms/add"}>
                <button className='w-[186px] h-[49px] bg-[#00B3A8] rounded-[5px] Poppins-SemiBold leading-[21px] text-[14px] text-white'>Xona qo’shish</button>
            </Link>
        </div>

        <div
          ref={scrollRef}
          className="relative mt-[20px] w-full overflow-hidden bg-gray-100 pr-12"
        >
            ...
            <table className="rounded-t-lg bg-white w-full  table-fixed">
              <thead className="bg-[#EEF0F4]">
                <tr>
                  ...
                  <th className="rounded-tr-lg  py-3  w-1/3">
                    <p className="text-[14px] leading-[21px] text-[#787F95]">bandlik holati</p>
                  </th>
                  <th className="rounded-tr-lg py-3 w-1/3">
                  </th>
                </tr>
                ...
                {data.map((item, index) => (
                  <tr className="border-b" key={index}>
                    ...
                    <td onClick={() => setIsopen(true)} className=" py-3 pl-6">
                      <p className=" text-[16px] leading-[20px] text-[#00B3A8] border-[#00B3A8] border-b-[1px] cursor-pointer text-center w-[101px]">
                        {item.specialty}
                      </p>
                    </td>
                    <td className=" py-3 pl-6">
                      <div className='w-[108px] h-[32px] border-[1px] rounded-[100px] flex items-center bg-[#e1faf3] justify-center border-[#00C98D] text-[#00C98D] text-[14px] leading-[21px]'>{item.statusBank}</div>
                    </td>
        ...
        {isopen && (
          <div className='w-[703px] h-[375px] bg-[#FFFFFF] absolute z-50 top-0 rounded-[12px] left-[230px]'>
              <div className='flex items-center justify-center pt-[40px] pl-[270px]'>
                  <h4 className='text-[28px] leading-[42px]'>Izoh</h4>
                  <div onClick={() => setIsopen(false)} className='cursor-pointer ml-[300px]'><h4 className='text-[#C2C4CA] text-[20px]'>X</h4></div>
              </div>
              <div className='w-[623px] p-9  pb-16 ml-[40px] mt-[40px] border-[#EEF0F4] border-[1.5px] flex items-center justify-center'>
