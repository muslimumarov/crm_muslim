          ...
          <div className="mt-[42px] pl-[42px]">
            <div>
              <h4 className="text-[22px] leading-[33px] text-[#002B48]">
                O’qish haqidagi ma’lumotlar
              </h4>
            </div>
            <div className="mt-[40px]">
              {/* MUTAXASISLIK VA ROLI INPUT*/}
              <div className="mt-[16px] flex items-center gap-[40px]">
                <Input  icon={Icons.Menu400} placeholder={'Mutaxassislik'}/>
                <Input  icon={Icons.Menu400} placeholder={'Foydalanuvchi roli'}/>
              </div>
  
              {/* Oylik VA Is bosh vaqt JOY INPUT*/}
              <div className="mt-[16px] flex items-center gap-[40px]">
                <Input placeholder={"Oylik maoshi"} icon={Icons.IdCard400} type={"text"}/>
                <Input icon={Icons.IdCard400} placeholder={'Guruhga biriktirish'}/>
              </div>
